      ...
      case "chassis-to-rc":
        return (
          <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Circular background */}
            <circle cx="32" cy="32" r="28" fill="url(#chassisBg)" stroke="#1e293b" strokeWidth="1" />
            
            {/* Red Car Vector */}
            <path d="M16 38C16 34 20 33 32 33C44 33 48 34 48 38L45 44H19L16 38Z" fill="#ef4444" />
            ...
            <circle cx="28" cy="27" r="6.5" fill="none" stroke="#60a5fa" strokeWidth="2.5" />
            <line x1="33" y1="32" x2="39" y2="38" stroke="#60a5fa" strokeWidth="2.5" strokeLinecap="round" />
            
            {/* Banner details */}
            <rect x="12" y="47" width="40" height="4.5" rx="1" fill="#1e3a8a" />
            <text x="32" y="50.5" fill="white" fontSize="3.2" fontWeight="extrabold" textAnchor="middle" fontFamily="sans-serif" letterSpacing="0.2">CHASSIS</text>
          </svg>
        );
      case "engine-to-rc":
        return (
          <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Circular background */}
            <circle cx="32" cy="32" r="28" fill="url(#engineBg)" stroke="#1e293b" strokeWidth="1" />
            
            {/* Blue Car Vector */}
            <path d="M16 38C16 34 20 33 32 33C44 33 48 34 48 38L45 44H19L16 38Z" fill="#3b82f6" />
            ...
            {/* Banner details */}
            <rect x="12" y="47" width="40" height="4.5" rx="1" fill="#1e3a8a" />
            <text x="32" y="50.5" fill="white" fontSize="3.2" fontWeight="extrabold" textAnchor="middle" fontFamily="sans-serif" letterSpacing="0.2">ENGINE</text>
          </svg>
        );
      case "dl-to-cell":
        return (
          <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Circular background */}
            <circle cx="32" cy="32" r="28" fill="url(#dlBg)" stroke="#1e293b" strokeWidth="1" />
            
            {/* Driving License card representation */}
            <rect x="12" y="22" width="22" height="15" rx="1" fill="#e2e8f0" stroke="#94a3b8" strokeWidth="0.8" />
            <circle cx="16.5" cy="27" r="2" fill="#3b82f6" />
            <line x1="21.5" y1="25" x2="30.5" y2="25" stroke="#475569" strokeWidth="1" />
            <line x1="21.5" y1="28" x2="28.5" y2="28" stroke="#475569" strokeWidth="1" />
            <line x1="15" y1="32" x2="30" y2="32" stroke="#475569" strokeWidth="0.8" />
            <line x1="15" y1="34" x2="26" y2="34" stroke="#475569" strokeWidth="0.8" />
            
            {/* Mobile smartphone link representing find */}
            <rect x="38" y="20" width="13" height="23" rx="2" fill="#1e293b" stroke="white" strokeWidth="1" />
            <circle cx="44.5" cy="40.5" r="1" fill="white" />
            <path d="M41 23H48V38H41V23Z" fill="#15803d" />
            {/* Link arrows */}
            <path d="M34 27.5C36 27.5 37 28.5 38 29.5" stroke="#60a5fa" strokeWidth="1" strokeLinecap="round" />
            <path d="M38 31.5C37 32.5 36 33.5 34 33.5" stroke="#60a5fa" strokeWidth="1" strokeLinecap="round" />

            {/* Banner details */}
            <rect x="12" y="47" width="40" height="4.5" rx="1" fill="#1e3a8a" />
            <text x="32" y="50.5" fill="white" fontSize="3.2" fontWeight="extrabold" textAnchor="middle" fontFamily="sans-serif" letterSpacing="0.2">LICENCE</text>
          </svg>
        );
      default:
        return null;
