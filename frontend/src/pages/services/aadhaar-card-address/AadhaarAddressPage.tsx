...
export function AadhaarAddressPage() {
  ...
  const [activeForm, setActiveForm] = useState<string | null>(null); // "address-correction-above-18" | "eid-to-aadhaar-pdf" | "aadhaar-to-pdf" | null
    ...
    switch (id) {
      case "address-correction-above-18":
        return (
          <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect x="4" y="10" width="56" height="44" rx="4" fill="white" stroke="#334155" strokeWidth="2" />
            <rect x="4" y="10" width="56" height="6" fill="#f59e0b" />
            {/* Fingerprint outline */}
            <path d="M26 28C26 25 28 23 32 23C36 23 38 25 38 28" stroke="#ef4444" strokeWidth="2" strokeLinecap="round" />
            <path d="M22 31C22 26 26 21 32 21C38 21 42 26 42 31" stroke="#ef4444" strokeWidth="1.5" strokeLinecap="round" />
            <line x1="14" y1="36" x2="32" y2="36" stroke="#475569" strokeWidth="2.5" />
            <line x1="14" y1="42" x2="28" y2="42" stroke="#475569" strokeWidth="2.5" />
            {/* Pen Correction */}
            <path d="M46 36L50 32L55 37L51 41L46 36Z" fill="#f59e0b" />
            <path d="M45 39L46 36L50 40L45 39Z" fill="#334155" />
            {/* Text labeling inside box */}
            <text x="32" y="50" fill="#334155" fontSize="4.2" fontWeight="black" textAnchor="middle" fontFamily="sans-serif">AADHAAR ADDRESS</text>
          </svg>
        );
      ...
      case "aadhaar-to-pdf":
        return (
          <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <linearGradient id="eidAadhaarBg" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="#8fa9b8" />
                <stop offset="100%" stopColor="#4f6b7c" />
              </linearGradient>
            </defs>
            {/* Outer Rounded Container */}
            <rect x="4" y="4" width="56" height="56" rx="10" fill="url(#eidAadhaarBg)" />
            {/* White Rounded Inner Card */}
            <rect x="14" y="14" width="36" height="36" rx="6" fill="white" stroke="#e2e8f0" strokeWidth="1" />
            
            {/* Document Lines */}
            <rect x="22" y="20" width="20" height="2.5" rx="0.5" fill="#1e293b" />
            <line x1="22" y1="26" x2="36" y2="26" stroke="#475569" strokeWidth="2" strokeLinecap="round" />
            <line x1="22" y1="31" x2="32" y2="31" stroke="#475569" strokeWidth="2" strokeLinecap="round" />
            <line x1="22" y1="36" x2="30" y2="36" stroke="#475569" strokeWidth="2" strokeLinecap="round" />

            {/* Gear / Cog Icon on Bottom Right of Document */}
            <circle cx="38" cy="36" r="5" fill="#f1f5f9" stroke="#1e293b" strokeWidth="1.5" />
            <circle cx="38" cy="36" r="2.5" fill="none" stroke="#1e293b" strokeWidth="1.5" />
            {/* Gear teeth */}
            <path d="M38 29.5V31.5M38 40.5V42.5M31.5 36H33.5M40.5 36H42.5" stroke="#1e293b" strokeWidth="1.5" strokeLinecap="round" />
            <path d="M33.4 31.4L34.8 32.8M41.2 39.2L42.6 40.6M33.4 40.6L34.8 39.2M41.2 32.8L42.6 31.4" stroke="#1e293b" strokeWidth="1.5" strokeLinecap="round" />

            {/* "SERVICE" Text */}
            <text x="32" y="46" fill="#475569" fontSize="4.5" fontWeight="bold" textAnchor="middle" fontFamily="sans-serif" letterSpacing="0.2">SERVICE</text>
          </svg>
        );
      default:
        return null;
  ...
  const getBreadcrumbLabel = () => {
    if (activeForm === "address-correction-above-18") return "Adress Correction (above 18)";
    if (activeForm === "eid-to-aadhaar-pdf") return "EID to Adhaar PDF Apply";
    if (activeForm === "aadhaar-to-pdf") return "Adhaar Number to Adhaar PDF Apply";
    return "";
  };
          ...
          <div className="w-full">
            <div className="w-full bg-white dark:bg-[#090d16] border border-slate-100 dark:border-slate-900/60 rounded-3xl p-6 md:p-8 shadow-sm flex flex-col gap-6 relative overflow-hidden animate-in fade-in duration-200">
              ...
              {activeForm === "address-correction-above-18" ? (
                <AddressCorrectionAbove18 onCancel={() => setActiveForm(null)} />
