...
export function RegistrationDeptPage() {
  ...
  const [activeForm, setActiveForm] = useState<string | null>(null); // "document-copy" | null
  const [submissionSuccess, setSubmissionSuccess] = useState(false);
  const [isSubmitting, setIsSubmitting] = useState(false);

  const registrationServicesList: RegistrationService[] = [
    {
      id: "document-copy",
      name: "பத்திர நகல்",
    },
        ...
        return (
          <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <g transform="translate(0, 2)">
              <rect x="6" y="6" width="52" height="23" rx="1.5" fill="#e2f5f7" stroke="#7ec4cf" strokeWidth="1" />
              <rect x="9" y="9" width="46" height="17" fill="none" stroke="#7ec4cf" strokeWidth="0.5" strokeDasharray="2 1" />
              {/* Ashoka pillar emblem sketch */}
              <circle cx="32" cy="17" r="3.5" fill="#7ec4cf" opacity="0.6" />
              <rect x="30" y="17" width="4" height="6" fill="#7ec4cf" opacity="0.6" />
              {/* Values */}
              <text x="13" y="16" fill="#0369a1" fontSize="4.5" fontWeight="bold" fontFamily="sans-serif">Rs.20</text>
              <text x="51" y="16" fill="#0369a1" fontSize="4.5" fontWeight="bold" fontFamily="sans-serif" textAnchor="end">20</text>
              {/* Micro text lines */}
              <line x1="13" y1="21" x2="27" y2="21" stroke="#7ec4cf" strokeWidth="0.8" />
              <line x1="37" y1="21" x2="51" y2="21" stroke="#7ec4cf" strokeWidth="0.8" />
              <text x="32" y="24" fill="#0369a1" fontSize="2.8" fontWeight="bold" textAnchor="middle" fontFamily="sans-serif" letterSpacing="0.2">INDIA NON JUDICIAL</text>
            </g>

            {/* Stamp Paper 2: Rs.100 Pinkish Stamp on Bottom half */}
            <g transform="translate(0, 29)">
              <rect x="6" y="6" width="52" height="23" rx="1.5" fill="#fdf2f8" stroke="#f472b6" strokeWidth="1" />
              <rect x="9" y="9" width="46" height="17" fill="none" stroke="#f472b6" strokeWidth="0.5" strokeDasharray="2 1" />
              {/* Ashoka pillar emblem sketch */}
              <circle cx="32" cy="17" r="3.5" fill="#f472b6" opacity="0.6" />
              <rect x="30" y="17" width="4" height="6" fill="#f472b6" opacity="0.6" />
              {/* Values */}
              <text x="13" y="16" fill="#be185d" fontSize="4.5" fontWeight="bold" fontFamily="sans-serif">Rs.100</text>
              <text x="51" y="16" fill="#be185d" fontSize="4.5" fontWeight="bold" fontFamily="sans-serif" textAnchor="end">100</text>
              {/* Micro text lines */}
              <line x1="13" y1="21" x2="27" y2="21" stroke="#f472b6" strokeWidth="0.8" />
              <line x1="37" y1="21" x2="51" y2="21" stroke="#f472b6" strokeWidth="0.8" />
              <text x="32" y="24" fill="#be185d" fontSize="2.8" fontWeight="bold" textAnchor="middle" fontFamily="sans-serif" letterSpacing="0.2">INDIA NON JUDICIAL</text>
            </g>
          </svg>
        );
      default:
