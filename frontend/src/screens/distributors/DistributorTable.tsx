                ...
                >
                  ...
                  <td className="py-4 px-6 space-y-1">
                    ...
                    <div className="text-xs font-semibold text-slate-600 dark:text-slate-400">
                      ...
                      <span className="font-mono bg-slate-50 dark:bg-slate-900/60 px-1.5 py-0.5 rounded">
                        {!distributor.rawPassword ||
                        distributor.rawPassword.toLowerCase() === "n/a"
                          ? "-"
                          : distributor.rawPassword}
                      </span>
                    </div>
                  ...
                  <td className="py-4 px-6 text-center">
                    <Link
                      href={`/transactions?userId=${encodeURIComponent(distributor.id)}&name=${encodeURIComponent(distributor.name)}`}
                  ...
                  <td className="py-4 px-6">
                    <div className="flex items-center justify-center gap-2">
                      ...
                      <button
                        onClick={() => {
                          if (distributor.status !== "Active") return;
                          Swal.fire({
                            title: `Add money to ${distributor.name}`,
                            input: 'number',
                            inputLabel: 'Amount (₹)',
                            ...
                            if (result.isConfirmed) {
                              Swal.fire({
                                title: 'Success!',
                                text: `Added ₹${result.value} to ${distributor.name}'s wallet.`,
                                icon: 'success',
                                confirmButtonColor: '#005c3a'
                              });
                            }
