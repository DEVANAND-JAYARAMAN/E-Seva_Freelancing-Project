...
const DEFAULT_SUB_SERVICES: Record<string, SubService[]> = {
  ...
  "aadhaar-card-address": [
    ...
    },
    {
      ...
      adminPrice: 1600.0,
      distributorPrice: 1600.0,
      retailerPrice: 1600.0,
      needCoordinator: false,
    },
  ],
  "can-edit": [
    ...
    {
      id: "father-name-correction",
      name: "Father Name Correction",
      adminPrice: 60.0,
      distributorPrice: 50.0,
      retailerPrice: 50.0,
      needCoordinator: false,
    ...
    {
      id: "legal-heir-cert-no",
      name: "Legal Heir Certificate Number",
      adminPrice: 60.0,
      distributorPrice: 50.0,
      retailerPrice: 50.0,
      needCoordinator: false,
    ...
    {
      id: "cell-number-dob",
      name: "Cell Number + Date of Birth",
      adminPrice: 60.0,
      distributorPrice: 50.0,
      retailerPrice: 50.0,
      needCoordinator: false,
    ...
    {
      id: "name-cell-number-dob",
      name: "Name + Cell Number + DOB",
      adminPrice: 60.0,
      distributorPrice: 50.0,
      retailerPrice: 50.0,
      needCoordinator: false,
    ...
    {
      id: "saved-app-removed",
      name: "Saved Application Removed",
      adminPrice: 60.0,
      distributorPrice: 50.0,
      retailerPrice: 50.0,
      needCoordinator: false,
    ...
    {
      id: "return-app-removed",
      name: "Return Application Removed",
      adminPrice: 60.0,
      distributorPrice: 50.0,
      retailerPrice: 50.0,
      needCoordinator: false,
