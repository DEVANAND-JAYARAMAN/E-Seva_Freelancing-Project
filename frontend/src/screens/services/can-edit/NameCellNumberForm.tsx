...
interface NameCellNumberFormProps {
  onCancel: () => void;
}

export const NameCellNumberForm: React.FC<NameCellNumberFormProps> = ({
  onCancel,
}) => {
        ...
        <div className="py-16 flex flex-col items-center justify-center text-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400 dark:text-slate-555 mt-2 max-w-md leading-relaxed">
              Your request for **Name + Cell Number** has been registered. The
