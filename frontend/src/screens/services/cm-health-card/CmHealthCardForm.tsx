...
export const CmHealthCardForm: React.FC<CmHealthCardFormProps> = ({
  ...
  const retailerCharge = getCharge({
    ...
    serviceId: "cm-health-card",
    serviceName: "CM Health Card",
    fallback: 200,
  });
  ...
  const { isForm, startPayment, paymentView } = usePaidServiceFlow({
    serviceId: "cm-health-card",
    serviceName: "CM Health Card",
    pricingCategoryId: "cm-health-card",
    retailerCharge,
    formData,
    files: selectedFiles,
    onDone: onCancel,
      ...
      <div className="space-y-5">
        ...
        <div data-form-fields-grid className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <SelectField
            ...
            onChange={(val, file) =>
              handleFieldChange("familyRelationName", val, file)
            }
          />
          ...
          <SelectField
            ...
            onChange={(val, file) =>
              handleFieldChange("maritalStatus", val, file)
            }
          />
        </div>
      </div>
      ...
      <div className="space-y-5">
        ...
        <div data-form-fields-grid className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <InputField
            ...
            onChange={(val, file) =>
              handleFieldChange("vaoCertificateFile", val, file)
            }
          />
          ...
          <InputField
            ...
            onChange={(val, file) =>
              handleFieldChange("smartcardFile", val, file)
            }
          />
          ...
          <InputField
            ...
            onChange={(val, file) =>
              handleFieldChange("aadhaarCardFile", val, file)
            }
          />
          ...
          <InputField
            ...
            onChange={(val, file) =>
              handleFieldChange("livePhotoFile", val, file)
            }
          />
          ...
          <InputField
            ...
            onChange={(val, file) =>
              handleFieldChange("passportPhotoFile", val, file)
            }
          />
        </div>
      </div>
