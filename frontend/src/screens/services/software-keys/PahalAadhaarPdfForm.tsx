...
interface PahalAadhaarPdfFormProps {
  price: number;
...
export const PahalAadhaarPdfForm: React.FC<PahalAadhaarPdfFormProps> = ({
  price,
  onSubmit,
  onCancel,
  isLoading = false,
        ...
        <div className="flex flex-col sm:flex-row sm:items-start justify-between border-b border-slate-100 dark:border-slate-900/50 pb-4 gap-2">
          <div>
            <h2 className="text-xl font-extrabold text-slate-900 dark:text-white capitalize">
              Pahal Aadhaar pdf Maker
            </h2>
            <p className="text-xs text-slate-450 dark:text-slate-500 mt-0.5">
              Register Pahal Aadhaar pdf Maker software key.
            </p>
          </div>
