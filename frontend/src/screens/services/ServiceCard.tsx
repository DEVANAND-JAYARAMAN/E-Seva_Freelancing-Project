...
export function ServiceCard({
  ...
  if (layout === "horizontal") {
    return (
      <article
        ...
        className={`bg-white dark:bg-[#090d16] border-2 border-black dark:border-white rounded-3xl p-6 shadow-sm flex items-center gap-5 border-l-4 border-l-transparent transition-all duration-300 relative ${
          isManageMode
  ...
  return (
    <article
      onClick={isManageMode ? undefined : onClick}
      className={`bg-white dark:bg-[#090d16] border-2 border-black dark:border-white rounded-3xl p-6 shadow-sm flex flex-col items-center text-center gap-2 relative overflow-hidden transition-all duration-300 ${
        isManageMode
          ? "border-amber-400 dark:border-amber-500/50"
