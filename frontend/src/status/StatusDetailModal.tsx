...
import { X, Check, AlertOctagon, RefreshCw, Loader, Download, Eye, FileText, Image as ImageIcon, CheckCircle, Upload } from "lucide-react";
...
export function StatusDetailModal({
  ...
  if (ticket && ticket.formData) {
    for (const [key, val] of Object.entries(ticket.formData)) {
      ...
      if (lowerKey.includes("name") && !lowerKey.includes("father") && !lowerKey.includes("mother")) {
        customerName = val;
        break;
      }
    }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  >
                    <Upload size={16} />
                    {ackFiles.length > 0 ? `${ackFiles.length} File(s) Selected` : "Select Files"}
                  </button>
                  {ackFiles.length > 0 && (
