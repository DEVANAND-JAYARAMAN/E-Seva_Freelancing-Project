...
const DEFAULT_SUB_SERVICES: Record<string, SubService[]> = {
  tnega: [
    { id: "tnega-main", name: "TNeGA Services", adminPrice: 60.00, distributorPrice: 60.00, retailerPrice: 60.00, needCoordinator: false },
    { id: "tnega-income", name: "Income Certificate", adminPrice: 60.00, distributorPrice: 60.00, retailerPrice: 60.00, needCoordinator: false },
    { id: "tnega-community", name: "Community Certificate", adminPrice: 60.00, distributorPrice: 60.00, retailerPrice: 60.00, needCoordinator: false },
    { id: "tnega-nativity", name: "Nativity Certificate", adminPrice: 60.00, distributorPrice: 60.00, retailerPrice: 60.00, needCoordinator: false }
  ],
  "software-keys": [
    { id: "soft-main", name: "Software Keys", adminPrice: 450.00, distributorPrice: 400.00, retailerPrice: 400.00, needCoordinator: false },
    { id: "soft-win11", name: "Windows 11 Retail Key", adminPrice: 800.00, distributorPrice: 750.00, retailerPrice: 750.00, needCoordinator: false },
    { id: "soft-office", name: "Office 2021 Key", adminPrice: 1200.00, distributorPrice: 1100.00, retailerPrice: 1100.00, needCoordinator: false }
  ],
  msme: [
    { id: "msme-main", name: "MSME", adminPrice: 200.00, distributorPrice: 100.00, retailerPrice: 100.00, needCoordinator: false },
    { id: "msme-pan", name: "Pan To Msme Udhayam Find", adminPrice: 0.00, distributorPrice: 200.00, retailerPrice: 200.00, needCoordinator: false },
    { id: "msme-mobile", name: "Mobile To Msme Udhayam Find", adminPrice: 0.00, distributorPrice: 200.00, retailerPrice: 200.00, needCoordinator: false }
  ],
  "ration-card": [
    { id: "ration-main", name: "Ration Card Services", adminPrice: 50.00, distributorPrice: 40.00, retailerPrice: 40.00, needCoordinator: false },
    { id: "ration-new", name: "New Family Card Registration", adminPrice: 100.00, distributorPrice: 80.00, retailerPrice: 80.00, needCoordinator: false },
    { id: "ration-member", name: "Add New Family Member", adminPrice: 50.00, distributorPrice: 40.00, retailerPrice: 40.00, needCoordinator: false }
  ],
  gst: [
    { id: "gst-filing", name: "GST Filing", adminPrice: 250.00, distributorPrice: 200.00, retailerPrice: 200.00, needCoordinator: false },
    { id: "gst-reg", name: "GST Registration", adminPrice: 500.00, distributorPrice: 400.00, retailerPrice: 400.00, needCoordinator: false },
    { id: "gst-correction", name: "GST Correction", adminPrice: 300.00, distributorPrice: 250.00, retailerPrice: 250.00, needCoordinator: false }
  ],
  "aadhaar-card-address": [
    { id: "aadhaar-main", name: "Adhaar Card (Adress Correction)", adminPrice: 100.00, distributorPrice: 80.00, retailerPrice: 80.00, needCoordinator: false },
    { id: "aadhaar-address", name: "Aadhaar Address Update", adminPrice: 100.00, distributorPrice: 80.00, retailerPrice: 80.00, needCoordinator: false },
    { id: "aadhaar-mobile", name: "Aadhaar Mobile Link Info", adminPrice: 50.00, distributorPrice: 40.00, retailerPrice: 40.00, needCoordinator: false }
  ],
  "can-edit": [
    { id: "can-main", name: "CAN EDIT", adminPrice: 60.00, distributorPrice: 50.00, retailerPrice: 50.00, needCoordinator: false },
    { id: "can-new", name: "Create CAN Number", adminPrice: 60.00, distributorPrice: 50.00, retailerPrice: 50.00, needCoordinator: false },
    { id: "can-edit-sub", name: "CAN Correction", adminPrice: 60.00, distributorPrice: 50.00, retailerPrice: 50.00, needCoordinator: false }
  ],
  "rto-services": [
    { id: "rto-main", name: "RTO Services", adminPrice: 150.00, distributorPrice: 120.00, retailerPrice: 120.00, needCoordinator: false },
    { id: "rto-llr", name: "LLR Application", adminPrice: 150.00, distributorPrice: 120.00, retailerPrice: 120.00, needCoordinator: false },
    { id: "rto-dl", name: "DL Renewal", adminPrice: 250.00, distributorPrice: 200.00, retailerPrice: 200.00, needCoordinator: false }
  ],
  "registration-dept": [
    { id: "reg-main", name: "பதிவு துறை (Registration Dept)", adminPrice: 200.00, distributorPrice: 180.00, retailerPrice: 180.00, needCoordinator: false },
    { id: "reg-prop", name: "Property Registration", adminPrice: 500.00, distributorPrice: 450.00, retailerPrice: 450.00, needCoordinator: false },
    { id: "reg-ec", name: "EC Search (Encumbrance Certificate)", adminPrice: 100.00, distributorPrice: 80.00, retailerPrice: 80.00, needCoordinator: false }
  ],
  "voter-id": [
    { id: "voter-main", name: "Voter ID", adminPrice: 50.00, distributorPrice: 40.00, retailerPrice: 40.00, needCoordinator: false },
    { id: "voter-new", name: "New Voter Registration", adminPrice: 100.00, distributorPrice: 80.00, retailerPrice: 80.00, needCoordinator: false },
    { id: "voter-correct", name: "Voter Correction", adminPrice: 80.00, distributorPrice: 60.00, retailerPrice: 60.00, needCoordinator: false }
  ],
  fssai: [
    { id: "fssai-main", name: "FSSAI License", adminPrice: 180.00, distributorPrice: 150.00, retailerPrice: 150.00, needCoordinator: false },
    { id: "fssai-reg", name: "FSSAI Registration", adminPrice: 200.00, distributorPrice: 180.00, retailerPrice: 180.00, needCoordinator: false },
    { id: "fssai-renew", name: "FSSAI Renewal", adminPrice: 180.00, distributorPrice: 150.00, retailerPrice: 150.00, needCoordinator: false }
  ],
  "certificate-courses": [
    { id: "course-main", name: "Certificate Courses", adminPrice: 350.00, distributorPrice: 300.00, retailerPrice: 300.00, needCoordinator: false },
    { id: "course-dca", name: "DCA Course", adminPrice: 350.00, distributorPrice: 300.00, retailerPrice: 300.00, needCoordinator: false },
    { id: "course-tally", name: "Tally Essential Course", adminPrice: 400.00, distributorPrice: 350.00, retailerPrice: 350.00, needCoordinator: false }
  ],
  "employment-services": [
    { id: "emp-main", name: "EMPLOYMENT SERVICES", adminPrice: 80.00, distributorPrice: 70.00, retailerPrice: 70.00, needCoordinator: false },
    { id: "emp-reg", name: "Employment Registration", adminPrice: 80.00, distributorPrice: 70.00, retailerPrice: 70.00, needCoordinator: false },
    { id: "emp-renew", name: "Employment Renewal", adminPrice: 50.00, distributorPrice: 40.00, retailerPrice: 40.00, needCoordinator: false }
  ],
  "insurance-scheme": [
    { id: "ins-main", name: "காப்பீடு திட்டம் (Insurance Scheme)", adminPrice: 120.00, distributorPrice: 100.00, retailerPrice: 100.00, needCoordinator: false },
    { id: "ins-cm", name: "Chief Minister Insurance", adminPrice: 120.00, distributorPrice: 100.00, retailerPrice: 100.00, needCoordinator: false },
    { id: "ins-life", name: "Life Insurance Scheme", adminPrice: 200.00, distributorPrice: 180.00, retailerPrice: 180.00, needCoordinator: false }
  ],
  "police-verification": [
    { id: "police-main", name: "Police Verification", adminPrice: 150.00, distributorPrice: 130.00, retailerPrice: 130.00, needCoordinator: false },
    { id: "police-job", name: "Job Verification", adminPrice: 150.00, distributorPrice: 130.00, retailerPrice: 130.00, needCoordinator: false },
    { id: "police-tenant", name: "Tenant Verification", adminPrice: 150.00, distributorPrice: 130.00, retailerPrice: 130.00, needCoordinator: false }
  ],
  "patta-service": [
    { id: "patta-main", name: "பட்டா சேவை (Patta Service)", adminPrice: 60.00, distributorPrice: 50.00, retailerPrice: 50.00, needCoordinator: false },
    { id: "patta-transfer", name: "Patta Chitta Transfer", adminPrice: 100.00, distributorPrice: 80.00, retailerPrice: 80.00, needCoordinator: false },
    { id: "patta-fmb", name: "FMB Sketch", adminPrice: 80.00, distributorPrice: 70.00, retailerPrice: 70.00, needCoordinator: false }
  ],
  "utisl-pan": [
    { id: "pan-main", name: "Utisl Pan", adminPrice: 107.00, distributorPrice: 99.00, retailerPrice: 99.00, needCoordinator: false },
    { id: "pan-new-pan", name: "UTI New PAN", adminPrice: 107.00, distributorPrice: 99.00, retailerPrice: 99.00, needCoordinator: false },
    { id: "pan-correct", name: "UTI PAN Correction", adminPrice: 107.00, distributorPrice: 99.00, retailerPrice: 99.00, needCoordinator: false }
  ],
  "pstm-certificate": [
    { id: "pstm-main", name: "PSTM Certificate", adminPrice: 50.00, distributorPrice: 40.00, retailerPrice: 40.00, needCoordinator: false },
    { id: "pstm-1to10", name: "PSTM 1st to 10th", adminPrice: 50.00, distributorPrice: 40.00, retailerPrice: 40.00, needCoordinator: false },
    { id: "pstm-11to12", name: "PSTM 11th & 12th", adminPrice: 60.00, distributorPrice: 50.00, retailerPrice: 50.00, needCoordinator: false }
  ]
};
    ...
    case "employment-services":
      return (
        <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <circle cx="32" cy="32" r="20" fill="none" stroke="#94A3B8" strokeWidth="1.5" strokeDasharray="4 2" />
...
const servicesCatalog: ServiceCatalogItem[] = [
  ...
  { id: "ration-card", name: "Ration Card Services", color: "text-emerald-500" },
  { id: "gst", name: "GST Filing & Reg", color: "text-amber-600" },
  { id: "aadhaar-card-address", name: "Adhaar Card (Adress Correction)", color: "text-rose-500" },
  { id: "can-edit", name: "CAN EDIT", color: "text-indigo-500" },
  { id: "rto-services", name: "RTO Services", color: "text-orange-500" },
  { id: "registration-dept", name: "பதிவு துறை", subName: "Registration Dept", color: "text-pink-500" },
  { id: "voter-id", name: "Voter ID", color: "text-cyan-500" },
  { id: "fssai", name: "FSSAI", color: "text-lime-500" },
  { id: "certificate-courses", name: "Certificate Courses", color: "text-teal-500" },
  { id: "employment-services", name: "EMPLOYMENT SERVICES", color: "text-slate-500" },
  { id: "insurance-scheme", name: "காப்பீடு திட்டம்", subName: "Insurance Scheme", color: "text-emerald-500" },
  { id: "police-verification", name: "Police Verification", color: "text-violet-500" },
  { id: "patta-service", name: "பட்டா சேவை", subName: "Patta Service", color: "text-green-600" },
  { id: "utisl-pan", name: "Utisl Pan", color: "text-sky-500" },
  { id: "pstm-certificate", name: "PSTM Certificate", color: "text-purple-500" }
];
...
export function PaymentsPage() {
  ...
  const [activeCatalogItem, setActiveCatalogItem] = useState<ServiceCatalogItem | null>(null);
  const [showSuccessToast, setShowSuccessToast] = useState(false);

  // Pricing configuration persistent matrix
  const [pricingConfig, setPricingConfig] = useLocalStorage<Record<string, SubService[]>>(
  ...
  const filteredCatalog = useMemo(() => {
    return servicesCatalog.filter((item) => {
      ...
      const matchSub = item.subName?.toLowerCase().includes(searchTerm.toLowerCase());
  ...
  const handleCardClick = (item: ServiceCatalogItem) => {
    ...
    const existing = pricingConfig[item.id] || DEFAULT_SUB_SERVICES[item.id] || [
      { id: `${item.id}-default`, name: item.name, adminPrice: 0, distributorPrice: 0, retailerPrice: 0, needCoordinator: false }
    ];
          ...
          <div className="space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-slate-50 dark:border-slate-900/40 pb-3 gap-3">
              ...
              <div className="relative max-w-xs w-full sm:w-64">
                <Search size={14} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-400 dark:text-slate-555 pointer-events-none" />
                <input
                  type="text"
                ...
                <table className="w-full min-w-[700px] border-collapse text-left">
                  <thead>
                    <tr className="border-b border-slate-200 dark:border-slate-800 text-slate-500 dark:text-slate-400 text-[10px] font-extrabold uppercase tracking-widest bg-slate-50 dark:bg-slate-950/40">
                      ...
                      <th className="py-4 px-5 text-center w-36">Distributor</th>
                          ...
                          <td className="py-4 px-5 text-center">
                            <div className="relative inline-block w-full">
                              ...
                              <input
                                ...
                                step="0.01"
                                min="0"
                                value={row.adminPrice === 0 ? "0.00" : row.adminPrice}
                                onChange={(e) =>
                          ...
                          <td className="py-4 px-5 text-center">
                            <div className="relative inline-block w-full">
                              ...
                              <input
                                ...
                                step="0.01"
                                min="0"
                                value={row.distributorPrice === 0 ? "0.00" : row.distributorPrice}
                                onChange={(e) =>
                          ...
                          <td className="py-4 px-5 text-center">
                            <div className="relative inline-block w-full">
                              ...
                              <input
                                ...
                                step="0.01"
                                min="0"
                                value={row.retailerPrice === 0 ? "0.00" : row.retailerPrice}
                                onChange={(e) =>
                          ...
                          <td className="py-4 px-5 text-center">
                            <label className="inline-flex items-center justify-center cursor-pointer select-none">
                              <input
                                ...
                                onChange={(e) =>
                                  handleCoordinatorChange(row.id, e.target.checked)
                                }
          ...
          <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3 bg-emerald-500 dark:bg-emerald-600 border border-emerald-450 text-white px-5 py-3.5 rounded-2xl shadow-xl animate-in fade-in slide-in-from-bottom-5 duration-250">
            ...
            <div>
              ...
              <p className="text-[10px] font-bold opacity-90 mt-1.5">
                Service pricing matrix and coordinator status updated successfully.
              </p>
            </div>
          </div>
        )}
