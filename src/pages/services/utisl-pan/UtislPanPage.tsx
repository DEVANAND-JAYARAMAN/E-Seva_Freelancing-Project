...
export function UtislPanPage() {
  ...
  const [activeForm, setActiveForm] = useState<string | null>(null); // "pan-to-adhaar" | null
  const [submissionSuccess, setSubmissionSuccess] = useState(false);
  const [isSubmitting, setIsSubmitting] = useState(false);

  const utislPanServicesList: UtislPanService[] = [
    {
      id: "pan-to-adhaar",
      name: "Pan To Adhaar Number Find",
    },
  ];
      ...
      case "pan-to-adhaar":
        return (
          <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <linearGradient id="panToAdhaarBgGrad" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="#8fa9b8" />
                <stop offset="100%" stopColor="#4f6b7c" />
              </linearGradient>
            </defs>
            {/* Outer Rounded Container */}
            <rect x="4" y="4" width="56" height="56" rx="10" fill="url(#panToAdhaarBgGrad)" />
