      ...
      case "msme-main":
        return (
          <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <linearGradient id="msmeGradMain" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="#005c3a" />
                <stop offset="100%" stopColor="#10B981" />
              </linearGradient>
            </defs>
            <rect x="4" y="4" width="56" height="56" rx="8" fill="url(#msmeGradMain)" stroke="#10B981" strokeWidth="1.5" />
            <rect x="8" y="8" width="48" height="48" fill="none" stroke="#34D399" strokeWidth="1" strokeDasharray="3 1" />
            <rect x="14" y="14" width="36" height="18" rx="2" fill="white" />
            <text x="32" y="26" fill="#005c3a" fontSize="7" fontWeight="black" textAnchor="middle" fontFamily="sans-serif">MSME</text>
            <circle cx="32" cy="42" r="6" fill="#FBBF24" />
            <path d="M28 42L31 45L36 39" stroke="#005c3a" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        );
      case "msme-pan":
        return (
          <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <linearGradient id="msmeGradPan" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="#F59E0B" />
                <stop offset="100%" stopColor="#D97706" />
              </linearGradient>
            </defs>
            <rect x="4" y="14" width="56" height="36" rx="4" fill="url(#msmeGradPan)" stroke="#B45309" strokeWidth="1.5" />
            ...
            <text x="44" y="38" fill="white" fontSize="9" fontWeight="black" textAnchor="middle" fontFamily="sans-serif">PAN</text>
          </svg>
        );
      case "msme-mobile":
        return (
          <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <linearGradient id="msmeGradMob" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="#10B981" />
                <stop offset="100%" stopColor="#047857" />
              </linearGradient>
            </defs>
            <rect x="16" y="6" width="32" height="52" rx="6" fill="url(#msmeGradMob)" stroke="#064E3B" strokeWidth="1.5" />
            ...
            <text x="32" y="36" fill="#047857" fontSize="5" fontWeight="black" textAnchor="middle" fontFamily="sans-serif">UDYAM</text>
          </svg>
        );
      default:
        return null;
                  ...
                  <div className="py-16 flex flex-col items-center justify-center text-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-400 dark:text-slate-500 mt-2 max-w-md leading-relaxed">
                        Your full registration for **MSME / Udyam Certificate** has been registered. You can monitor the progress inside Service Status tab.
                      </p>
                    </div>
                  </div>
                ) : (
