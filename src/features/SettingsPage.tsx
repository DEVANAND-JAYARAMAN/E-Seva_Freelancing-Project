...
import { Settings, Shield, Bell, Moon, Sun, Lock, Eye, CheckCircle2 } from "lucide-react";
      ...
      <div className="space-y-6 max-w-4xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-300">
        ...
        <div>
          ...
          <p className="text-xs text-slate-450 dark:text-slate-500 font-semibold mt-1">
            Configure system themes, security credentials, and dispatch triggers.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="md:col-span-3">
            {activeTab === "security" && (
              <form onSubmit={handlePasswordSubmit} className="bg-white dark:bg-[#0c101d] border border-slate-200/60 dark:border-slate-800/40 rounded-2xl p-6 space-y-6 shadow-sm">
                <div className="border-b border-slate-100 dark:border-slate-800/60 pb-3 flex justify-between items-center">
                  <h3 className="text-sm font-bold text-slate-800 dark:text-slate-200 flex items-center gap-2">
                    <Shield size={16} className="text-[#005c3a] dark:text-emerald-400" />
                ...
                <div className="space-y-4">
                  <div className="space-y-1.5">
                    <label className="text-[11px] font-bold text-slate-450 dark:text-slate-500 uppercase tracking-wider">Current Password</label>
                    <input
                      type="password"
                      required
                      placeholder="••••••••"
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[11px] font-bold text-slate-450 dark:text-slate-500 uppercase tracking-wider">New Password</label>
                    <input
                      type="password"
                      required
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[11px] font-bold text-slate-450 dark:text-slate-500 uppercase tracking-wider">Confirm New Password</label>
                    <input
                      type="password"
                      required
            ...
            {activeTab === "notifications" && (
              <div className="bg-white dark:bg-[#0c101d] border border-slate-200/60 dark:border-slate-800/40 rounded-2xl p-6 space-y-6 shadow-sm">
                <div className="border-b border-slate-100 dark:border-slate-800/60 pb-3">
                  <h3 className="text-sm font-bold text-slate-800 dark:text-slate-200 flex items-center gap-2">
                    <Bell size={16} className="text-[#005c3a] dark:text-emerald-400" />
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 rounded-xl bg-slate-50 dark:bg-slate-900/40 border border-slate-100 dark:border-slate-800/20">
                    <div>
                      ...
                      <p className="text-[10px] text-slate-450 dark:text-slate-500 font-semibold mt-0.5">Receive transactional operations updates via email.</p>
                    </div>
                    <input
                      type="checkbox"
                  ...
                  <div className="flex items-center justify-between p-4 rounded-xl bg-slate-50 dark:bg-slate-900/40 border border-slate-100 dark:border-slate-800/20">
                    <div>
                      <p className="text-xs font-bold text-slate-800 dark:text-slate-200">Instant SMS Dispatches</p>
                      <p className="text-[10px] text-slate-450 dark:text-slate-500 font-semibold mt-0.5">Receive mobile SMS updates for quick action requests.</p>
                    </div>
                    <input
                      type="checkbox"
                  ...
                  <div className="flex items-center justify-between p-4 rounded-xl bg-slate-50 dark:bg-slate-900/40 border border-slate-100 dark:border-slate-800/20">
                    <div>
                      <p className="text-xs font-bold text-slate-800 dark:text-slate-200">Low Wallet Warning Triggers</p>
                      <p className="text-[10px] text-slate-450 dark:text-slate-500 font-semibold mt-0.5">Notify instantly when API or Main balance falls below ₹500.</p>
                    </div>
                    <input
                      type="checkbox"
                      checked={notifications.walletAlerts}
                      onChange={(e) => setNotifications({ ...notifications, walletAlerts: e.target.checked })}
                      className="h-4 w-4 rounded border-slate-350 text-[#005c3a] focus:ring-[#005c3a]"
                    />
                  </div>
                </div>
            ...
            {activeTab === "appearance" && (
              <div className="bg-white dark:bg-[#0c101d] border border-slate-200/60 dark:border-slate-800/40 rounded-2xl p-6 space-y-6 shadow-sm">
                <div className="border-b border-slate-100 dark:border-slate-800/60 pb-3">
                  <h3 className="text-sm font-bold text-slate-800 dark:text-slate-200 flex items-center gap-2">
                    {theme === "dark" ? (
                      <Moon size={16} className="text-[#005c3a] dark:text-emerald-400" />
                    ) : (
                      <Sun size={16} className="text-[#005c3a] dark:text-emerald-400" />
                    )}
                ...
                <div className="p-5 rounded-xl bg-slate-50 dark:bg-slate-900/40 border border-slate-100 dark:border-slate-800/20 flex items-center justify-between">
                  <div className="space-y-0.5">
                    <p className="text-xs font-bold text-slate-800 dark:text-slate-200">
                      System Display Theme ({theme === "dark" ? "Dark Mode" : "Light Mode"})
                    </p>
